...
\usepackage{fancyhdr}
\usetikzlibrary{mindmap,shadows, shapes, plotmarks, arrows, positioning}

%% Change these:
\newcommand{\projecttitle}{A platform for creating and managing custom matches for online games}
\newcommand{\projectauthor}{Ethan Horrigan}
